...
- **Docker:** Ready-to-use Docker configuration for deployment. Note: The Komodo deployment docker-compose is located in `docs/komodo-compose.yaml`.
...
- **Run Tests:**
  ...
  _Note: Tests require valid Twitter credentials in environment variables (see `README.md`)._
